...
import org.apache.clerezza.rdf.utils.smushing.BaseSmusher;
 ...
 * @author reto
 */
public class IriSmusher extends BaseSmusher {
    
    static final Logger log = LoggerFactory.getLogger(IriSmusher.class);

<@namespace dlc="http://fusepool.eu/ontologies/dlc#" />
...
<div id="wrapper">
	...
	<@ldpath path="dlc:graph/dlc:pipe">
	        <div id="dataset">
			<h2>Dataset: <@ldpath path="rdfs:label"/></h2>
			<h2> Status: <span id="status"><@ldpath path="dlc:status/rdfs:label"/></span> </h2>
			<table>
			<tr><th>Name</th><th>Size</th><th></th><th></th></tr>
			<@ldpath path="dlc:creates/dlc:deliverable">					
				<tr>
				<td><@ldpath path="."/></td>
				<td><@ldpath path="dlc:size"/></td>
				<td>
